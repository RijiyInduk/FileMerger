...
TXTFilesMerger - приложение для Windows, объединяющее несколько текстовых файлов (исходный код, конфиги, документацию) в один выходной файл с чёткими разделителями — идеально подходит для передачи всей кодовой базы в LLM (ChatGPT, Claude, Gemini) одной вставкой.
